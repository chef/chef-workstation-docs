...
Description
: URL of a Chef Automate [data collection](https://docs.chef.io/automate/data_collection/) endpoint. This URL is provided to the target host, allowing it to report to Automate when `chef-run` is used to converge the target. A valid token generated by Automate is required.
