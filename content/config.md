...
Description
: URL of an Automate [data collection](https://docs.chef.io/automate/data_collection/) endpoint. This URL is provided to the target host, allowing them to report in to Automate when `chef-run` is used to converge the targets. A valid token generated by automate is required.
...
Description
: An Automate [API token](https://docs.chef.io/automate/api_tokens/#creating-api-tokens), used on target host to authenticate to the `url` provided.
