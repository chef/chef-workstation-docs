...
[menu]
  [menu.tools]
    title = "knife supermarket"
    identifier = "tools/knife/reference/knife_supermarket.md knife supermarket"
...
{{< readfile file="content/reusable/md/notes_knife_cookbook_site_use_devkit_berkshelf.md" >}}
